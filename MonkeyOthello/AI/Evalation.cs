...
{    
    ...
    class Evalation
    {
        ...
        /// <summary>
        /// 获取四条边的得分,预先把所有不同的情况的分数存入score_edge数组里.
        /// </summary>
        /// <param name="edge"></param>
        /// <param name="emptiesIndex"></param>
        /// <param name="color"></param>
        /// <returns></returns>
        ...
        //    if ((edge[0] == color) && (edge[7] == color))
        //    {
        //        score += weight_train[emptiesIndex, IND_KEYNO] / 2;
        //        for (int i = 1; i <= 6; i++)
        //            if (edge[i] == color)
        //                score += weight_train[emptiesIndex, IND_MYSTAB];
        //        return score;
        ...
        ///// <returns></returns>
        //public int StartEval(ChessType[] board, ChessType color, ChessType oppcolor, int empties)
        //{
        //    int eval = 0;
        //    //棋子数
        //    int mydisc = 0;
        ...
        //        {
        //            if (Board.AnyFlips(board, i, color, oppcolor))
        //                mymob++;
        //            //else if (Board.AnyPotMobility(board, i, oppcolor))
        //            //    mypotmob++;
        //            if (Board.AnyFlips(board, i, oppcolor, color))
        //                opmob++;
        //            //else if (Board.AnyPotMobility(board, i, color))
        //            //    oppotmob++;
        //        }
        ...
        //    unstab = getUnStab_Start(board, color) - getUnStab_Start(board, oppcolor);

        //    eval = (mydisc - opdisc) * Constants.DiscWeight + (mymob - opmob) * Constants.MobilityWeight + (mypotmob - oppotmob) * Constants.PotMobilityWeight +
        //        deltakeyano * Constants.KeyanoWeight + unstab * Constants.UnStabilityWeight;
        ...
        ///// <param name="empties"></param>
        ///// <returns></returns>
        //public int MidEval(ChessType[] board,ChessType color, ChessType oppcolor,int empties)
        //{
        //    int  eval=0;
        //    //棋子数
        //    int mydisc=0;
        ...
        //        {
        //            mydisc++;
        //            if(Board.AnyStab(board, i, color))
        //                mystab++;
        //        }
        //        else if (board[i] == oppcolor)
        //        {
        //            opdisc++;
        //            if( Board.AnyStab(board, i, oppcolor))
        //                opstab++;
        //        }
        //    }
        ...
        //    //eval=(mymob-opmob)*Constants.MobilityWeight+(mypotmob-oppotmob)*Constants.PotMobilityWeight+
        //    //    (mystab-opstab)*Constants.FourStabilityWeight+
        //    //     deltakeyano * Constants.KeyanoWeight + (myunstab - opunstab) * Constants.UnStabilityWeight;
        //    //if (board[40] == color)
        //    //    eval += Constants.MiddleWeight;
        //    //else if(board[40]==oppcolor)
        //    //    eval -= Constants.MiddleWeight;
        ...
        private int get_score_edge_all(ChessType[] board,ChessType color,int empties)
        {
            ...
            score += score_edge[index, empties];
            //当电脑持黑时
            //return (color == ChessType.BLACK ? score: -score);
            //return -score;
            //当电脑持白时
            return score;
        ...
        public int StaEval2(ChessType[] board, ChessType color, ChessType oppcolor, int empties, Empties EmHead)
        {
            ...
            {
                sqnum = em.Square;
                if (Board.AnyFlips(board, sqnum, color, oppcolor))
                    mymob++;
                else if (Board.AnyPotMobility(board, sqnum, oppcolor))
                    mypotmob++;
                if (Board.AnyFlips(board, sqnum, oppcolor, color))
                    opmob++;
                else if (Board.AnyPotMobility(board, sqnum, color))
                    oppotmob++;
            }
            ...
            for (int i = 0; i < midBoardLength; i++)
            {
                ...
                {
                    mydisc++;
                    if (Board.AnyStab(board, sqnum, color))
                        mystab++;
                }
                else if (board[sqnum] == oppcolor)
                {
                    opdisc++;
                    if (Board.AnyStab(board, sqnum, oppcolor))
                        opstab++;
                }
            }
