...
namespace MonkeyOthello.Core.Evaluation
{
    public struct EvaluationNode : INode
	{
        ...
        {
            get { return Rule.PotentialMobility(GameState.PlayerPieces, GameState.EmptySquares).CountBits(); }
        }

        public short OpponentFrontier
        {
            get { return Rule.PotentialMobility(GameState.OpponentPieces, GameState.EmptySquares).CountBits(); }
        }
